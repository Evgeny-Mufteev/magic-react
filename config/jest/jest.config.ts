...
export default {
    ...
    // An array of glob patterns indicating a set of files for which coverage i
    // nformation should be collected
    ...
    // E.g.maxWorkers: 10% will use 10% of your CPU amount + 1 as the
